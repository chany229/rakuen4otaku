...
database_name = case Padrino.env
  when :development then 'rakuen4otaku_development'
  when :production  then 'rakuen4otaku_production'
  when :test        then 'rakuen4otaku_test'
end
...
#     sessions:
#       default:
#         database: rakuen4otaku_development
#         hosts:
#           - localhost:27017 
#   production:
#     sessions:
#       default:
#         database: rakuen4otaku_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: rakuen4otaku_test
#         hosts:
#           - localhost:27017
#
#
